...
imgsz = check_img_size(imgsz=(1280, 1280), s=stride)  # check image size
half=False
# Half
...
@torch.no_grad()
def run(weights= weights , #ROOT / 'best.pt'
        source= ROOT / 'Detect_Source/*.jpg', #ROOT / 'filename.jpg'
        ...
        name='task',  # save results to project/name
